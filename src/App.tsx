...
import { Play, Pause, LayoutTemplate, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="h-[100dvh] w-full relative bg-black text-white overflow-hidden font-sans">
      ...
      <div className="relative z-10 h-full overflow-y-auto no-scrollbar flex flex-col">
        ...
        {/* Header */}
        <header className="p-6 flex justify-between items-center shrink-0 backdrop-blur-sm sticky top-0 z-50">
